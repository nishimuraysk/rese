        ...
        ?>
            <div class="reservation__content">
                ...
                <table class="reservation-table">
                    <tr>
                        <th class="reservation-column">Shop</th>
                        <td class="reservation-item">{{ $reservation['shop']['name'] }}</td>
                    </tr>
                    <tr>
                        <th class="reservation-column">Date</th>
                        <td class="reservation-item">{{ $reservation['date'] }}</td>
                    </tr>
                    <tr>
                        <th class="reservation-column">Time</th>
                        <td class="reservation-item">{{ substr($reservation['time'], 0, 5) }}</td>
                    </tr>
                    <tr>
                        <th class="reservation-column">Number</th>
                        <td class="reservation-item">{{ $reservation['number'] }}人</td>
                    </tr>
                    <tr>
                        <th class="reservation-column">Payment</th>
                        @if ( !empty($reservation['payment']) )
                        <td class="reservation-item">{{ $reservation['payment'] }}</td>
                        @else
                        <td class="reservation-item">
                            <a class="reservation__update__link" href="/payment/create/{{ $reservation['id'] }}">お支払いはこちら ＞</a>
                        </td>
                        @endif
                    </tr>
                </table>
