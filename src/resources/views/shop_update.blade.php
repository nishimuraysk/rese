    ...
    <div class="input__content">
        <form action="/shop/update/{{ $shop['id'] }}" method="POST">
            ...
            <div class="input__container">
                ...
                <input type="text" class="input-text" name="name" id="name" value="{{ $shop['name'] }}">
            </div>
            <div class="input__container">
            ...
            <div class="input__container">
                ...
                <textarea name="summary" id="summary" class="input-summary" value="{{ $shop['summary'] }}"  maxlength="255">{{ $shop['summary'] }}</textarea>
            </div>
            <div class="input__container">
                <label for="image" class="input-label">店舗画像</label>
                <input type="text" class="input-image" name="image" id="image" value="{{ $shop['image'] }}">
            </div>
            @if ( $errors->any() )
